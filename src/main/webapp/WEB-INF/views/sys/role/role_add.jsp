...
<div id="roleAddBox" class="box1">
    <fieldset>
      <legend>新增角色</legend>
      <form:form name="roleForm" id="roleForm" action="${ctx}/sys/role/add" method="post" commandName="sysRole" onsubmit="return validateForm();" failAlert="表单填写不正确，请按要求填写！">
		<table id="roleAddTable" class="tableStyle" formMode="line" style="width:100%;">
		  <tr>
