...
<div id="addBox" class="box1">
  <fieldset>
    <legend>新增数据字典类型</legend>
      <form:form name="sysDicForm" id="sysDicForm" action="${ctx}/sys/dic/addtype" method="post" commandName="sysDic" onsubmit="return validateForm();" failAlert="表单填写不正确，请按要求填写！">
...
<script type="text/javascript">
	...
	function ajaxDicType() {
		if ($("#dicType").val() != '') {
			$.ajax({
				url : '${ctx}/ajax/dic/dicType/isExists',
				type : 'POST',
				data : {
					dicType : $("#dicType").val()
				},
