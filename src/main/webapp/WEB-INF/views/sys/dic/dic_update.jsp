...
<body>
 <div id="updateBox" class="box1">
    <fieldset>
      ...
      <form:form name="sysDicForm" id="sysDicForm" action="${ctx}/sys/dic/update" method="post" commandName="sysDic" onsubmit="return validateForm();" failAlert="表单填写不正确，请按要求填写！">
	  <form:hidden path="id" />
	  <table id="updateTable" class="tableStyle" formMode="line" style="width:100%;">
		...
		<tr>
			...
			<td width="300">
			  <select data='<qjson:dicJSON type="parent" />' id="selectDicType" selectedValue="${sysDic.dicType }"
			  	 prompt="请选择" class="validate[required]" selWidth="250"
