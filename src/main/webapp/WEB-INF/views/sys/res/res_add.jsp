...
<body>
 <div id="addBox" class="box1">
    <fieldset>
      <legend>新增资源</legend>
      <form:form name="sysResourceForm" id="sysResourceForm" action="${ctx}/sys/res/add" method="post" commandName="sysResource" onsubmit="return validateForm();" failAlert="表单填写不正确，请按要求填写！">
	    <table id="addTable" class="tableStyle" formMode="line" style="width:100%;">
		  ...
		  <tr>	
			<td>上级菜单：</td>
			<td>
			  <div class="selectTree" prompt="请选择" data='<qjson:resJSON type="selectTree"/>'
                  id="selectParent" selWidth="250"></div>
			  <input type="hidden" name="parentId" id="parentId" />
			</td>
			<td>资源类别：</td>
			<td>
			  <select id="selectType" data='<qjson:dicJSON type="select" dicType="01"/>' selWidth="250"></select>
...
<link type="text/css" rel="stylesheet" href="${ctx}/libs/js/tree/ztree/ztree.css"></link>
<!-- 树组件end -->
<!-- 树形下拉框start -->
