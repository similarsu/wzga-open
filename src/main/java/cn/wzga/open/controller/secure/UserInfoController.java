    ...
    public HttpEntity userInfo(HttpServletRequest request) throws OAuthSystemException {
        try {
            ...
            if (!oAuthService.checkAccessToken(accessToken)) {
                ...
                OAuthResponse oauthResponse =
                        OAuthRSResponse.errorResponse(HttpServletResponse.SC_UNAUTHORIZED)
                                .setRealm(WebConstant.RESOURCE_SERVER_NAME)
            ...
            if (OAuthUtils.isEmpty(errorCode)) {
                OAuthResponse oauthResponse =
                        OAuthRSResponse.errorResponse(HttpServletResponse.SC_UNAUTHORIZED)
                                .setRealm(WebConstant.RESOURCE_SERVER_NAME).buildHeaderMessage();
            ...
            OAuthResponse oauthResponse =
                    OAuthRSResponse.errorResponse(HttpServletResponse.SC_UNAUTHORIZED)
                            .setRealm(WebConstant.RESOURCE_SERVER_NAME).setError(e.getError())
